...
class DSCAS(object):
    ...
    def pretrain(self, x, y=None, optimizer='adam', epochs=200, batch_size=256, save_dir='results/temp',
                 da_s1=False, verbose=1, use_multiprocessing=False):
        print('Pretraining......')
        ...
        if not da_s1:
            ...
            self.autoencoder.fit_generator(
                ...
                callbacks=cb, verbose=verbose, use_multiprocessing=False, workers=4)
    ...
    def fit(self, x, y=None, batch_size=256, epochs=100,
        ...
        for epoch in range(epochs+1):
            ...
            if y is not None:
                ...
                if epoch == 0:
                    print('DSCAS model saved to \'%s/model_init.h5\'' % save_dir)
                ...
                if (epoch > 0 and delta_y < tol) or epoch >= epochs:
                    ...
                    print('DSCAS model saved to \'%s/model_final.h5\'' % save_dir)
